...
def get_dataset(dataset_name, preprocess, location, batch_size=128, num_workers=0, subset_data_ratio=1.0, val_fraction=0.1, max_val_samples=5000):
    ...
    dataset = dataset_class(
        preprocess, location=location, batch_size=batch_size, num_workers=num_workers, subset_data_ratio=subset_data_ratio
    )
    return dataset
