...
method_name = 'ties_merging' # choose: weight_averaging | task_arithmetic | ties_merging | tw_adamerging | lw_adamerging | tw_adamergingpp | lw_adamergingpp
...
if is_visualization:
    ...
    args.logs_path = src_root_path + 'src/logs/run/' + model_name
...
if method_name in ['ties_merging', 'tw_adamergingpp', 'lw_adamergingpp']:
    ...
    for dataset_name in exam_datasets:
        try:
            finetuned_state_dict = torch.load(checkpoint_path + model_name + '/' + dataset_name + '/finetuned.pt').state_dict()
        except:
            finetuned_state_dict = pickle.load(open(checkpoint_path + model_name + '/' + dataset_name + '/finetuned.pt', 'rb')).state_dict()
        ft_checks.append(finetuned_state_dict)
